  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50">
      ...
      <main className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-16 flex-grow space-y-16">
        ...
        <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 text-white p-8 rounded-3xl shadow-xl flex flex-col md:flex-row gap-8 items-center justify-between relative overflow-hidden border border-slate-700/50">
          <div className="space-y-4 relative z-10 flex-1">
            <span className="bg-orange-500 text-white text-[9px] font-black uppercase px-3 py-1 rounded-full tracking-wider shadow-xs">
          ...
          <button
            ...
            className="gradient-btn text-white px-6 py-3 rounded-full font-heading font-bold text-xs uppercase tracking-wider shrink-0 relative z-10 cursor-pointer shadow-md transition-all"
          >
