                      ...
                      <div className="space-y-4">
                        ...
                        {item.highlights && item.highlights.length > 0 && (
                          <div className="flex flex-wrap gap-1.5 pt-2 border-t border-slate-100/60">
                            {item.highlights.slice(0, 3).map((hl, hlIdx) => (
                              <span
                                key={hlIdx}
                                className="bg-slate-50 border border-slate-100 text-slate-600 font-bold text-[8px] uppercase px-2 py-0.5 rounded-full"
                              >
                                {hl}
                              </span>
                            ))}
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-slate-100">
                          <div>
                            ...
                            <span className="text-xs font-heading font-black text-slate-950">
                              {(() => {
