...
export default function NewTopLocationPage() {
    ...
    <div className="max-w-xl mx-auto space-y-6 select-none animate-fadeIn">
      ...
      <div>
        ...
        <p className="text-xs text-slate-400 mt-0.5">
          Add a new high-profile location dynamically to the home page scroller.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white border border-slate-100 rounded-3xl p-6 md:p-8 shadow-xs space-y-6">
        ...
        <div className="pt-2">
          ...
          >
            {saving ? "Creating Location..." : "➕ Create Location"}
          </button>
        </div>
      </form>
    </div>
