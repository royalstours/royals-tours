    ...
    return (
      <div className="min-h-screen bg-slate-950 text-white flex flex-col justify-between">
        ...
        <div className="max-w-md mx-auto px-4 py-40 text-center">
          <svg className="w-16 h-16 stroke-amber-500 fill-none mx-auto mb-4" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
            <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" />
            <circle cx="12" cy="10" r="3" />
          </svg>
          <h1 className="text-3xl font-extrabold font-heading text-white">Destination Not Found</h1>
          <p className="text-slate-400 text-sm mt-2">
            The travel destination you are looking for might have been moved or updated.
          </p>
          <Link
            href="/destinations"
            className="mt-6 inline-block gradient-btn px-6 py-3 rounded-full text-xs font-bold font-heading"
          >
  ...
  return (
    <div className="relative min-h-screen bg-slate-50 text-slate-800">
      ...
      {/* ==========================================
          HERO BANNER SECTION
          ========================================== */}
      <section className="relative pt-32 pb-24 bg-slate-950 text-white overflow-hidden select-none">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-xs font-heading font-semibold text-slate-300 mb-6">
          ...
          <div className="max-w-3xl">
            {destination.badge && (
              <span className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-amber-500/20 border border-amber-400/40 text-amber-300 text-xs font-heading font-bold uppercase tracking-wider mb-4 backdrop-blur-md">
            ...
            <p className="mt-4 text-base sm:text-xl text-amber-300/90 font-heading italic">
              "{destination.slogan}"
            </p>

            {/* Key Quick Stats */}
            <div className="mt-8 flex flex-wrap items-center gap-4 text-xs font-medium text-slate-200">
              <div className="bg-slate-900/80 border border-slate-700/60 backdrop-blur-md px-4 py-2.5 rounded-xl flex items-center gap-2">
                <svg className="w-4.5 h-4.5 stroke-amber-500 fill-none shrink-0" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
                  <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" />
                  <circle cx="12" cy="10" r="3" />
                </svg>
                <div>
              ...
              <div className="bg-slate-900/80 border border-slate-700/60 backdrop-blur-md px-4 py-2.5 rounded-xl flex items-center gap-2">
                ...
                <div>
                  <span className="block text-[10px] text-slate-400 uppercase font-bold">Group Size</span>
              ...
              <div className="bg-slate-900/80 border border-slate-700/60 backdrop-blur-md px-4 py-2.5 rounded-xl flex items-center gap-2">
                ...
                <div>
                  <span className="block text-[10px] text-slate-400 uppercase font-bold">Best Season</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                        ...
                        >
                          ...
                          >
                            <div className="flex items-center gap-3 sm:gap-4">
                              <span className="w-10 h-10 rounded-xl bg-slate-900 text-amber-400 font-black font-heading flex items-center justify-center text-xs shrink-0 shadow-sm">
                                Day {day.day}
                              </span>
            ...
            <div className="lg:col-span-4">
              <div className="bg-slate-950 text-white rounded-3xl p-6 sm:p-8 border border-slate-800 shadow-2xl sticky top-28 space-y-6">
                    ...
                    <div className="space-y-2 max-h-60 overflow-y-auto pr-1">
                      {destination.pricingTiers.map((tier, idx) => (
                        ...
                        >
                          ...
                          {tier.details && (
                            <p className="text-[10px] font-normal text-slate-400 mt-1 leading-snug">
                              {tier.details}
                            </p>
                          )}
                        </button>
                ...
                {destination.pdfItineraryUrl && (
                  <div className="border-t border-slate-800 pt-4">
                    <a
                      ...
                      download
                      className="w-full bg-slate-900 hover:bg-slate-850 border border-slate-850 text-slate-200 py-3 rounded-xl font-heading font-bold text-xs text-center flex items-center justify-center gap-2 transition-colors cursor-pointer shadow-sm"
                    >
                ...
                <div className="border-t border-slate-800 pt-4 space-y-3">
                  <div className="flex items-center justify-between text-xs text-slate-300">
                    <span>Type:</span>
                    <span className="font-bold text-amber-400">{destination.badge}</span>
                  </div>
                  <div className="flex items-center justify-between text-xs text-slate-300">
                    <span>Location:</span>
                    <span className="font-bold text-white">{destination.name}</span>
                ...
                <button
                  ...
                  className="w-full gradient-btn py-4 rounded-full font-heading font-bold text-sm text-center flex items-center justify-center gap-2 cursor-pointer shadow-lg hover:scale-[1.02] transition-transform"
                >
                ...
                <div className="text-center pt-2">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-xs text-emerald-400 hover:underline inline-flex items-center gap-1.5 font-semibold"
                  >
