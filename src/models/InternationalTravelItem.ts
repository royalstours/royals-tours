...
export interface IInternationalTravelItem extends Document {
  name: string;
  title: string;
  slogan: string;
...
const InternationalTravelItemSchema = new Schema<IInternationalTravelItem>(
  {
    ...
    category: {
      type: String,
      required: true,
      enum: ["international", "domestic", "trek"],
    },
...
export default mongoose.models.InternationalTravelItem ||
  mongoose.model<IInternationalTravelItem>("InternationalTravelItem", InternationalTravelItemSchema);
