...
export interface IDomesticTravelItem extends Document {
  name: string;
  title: string;
  slogan: string;
...
const DomesticTravelItemSchema = new Schema<IDomesticTravelItem>(
  {
...
export default mongoose.models.DomesticTravelItem ||
  mongoose.model<IDomesticTravelItem>("DomesticTravelItem", DomesticTravelItemSchema);
