...
export interface ITravelItem extends Document {
  name: string;
  title: string;
  slogan: string;
...
const TravelItemSchema = new Schema<ITravelItem>(
  {
...
export default mongoose.models.TravelItem ||
  mongoose.model<ITravelItem>("TravelItem", TravelItemSchema);
